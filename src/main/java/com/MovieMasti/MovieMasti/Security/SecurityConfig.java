    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(HttpMethod.POST, "/v1/api/login", "/v1/api/signin", "/v1/api/logout").permitAll()
                        .requestMatchers(HttpMethod.GET, "/v1/api/home").permitAll()
                        .requestMatchers(HttpMethod.GET, "/v1/api/movies/**", "/v1/api/theaters/**", "/v1/api/shows/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/v1/api/movies", "/v1/api/theaters", "/v1/api/shows").hasRole("ADMIN")
